<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminOld.aspx.cs" Inherits="Admin" %>
...
<body>
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <div class="navbar-header" style="padding-right: 10px;">
            ...
            <a class="navbar-brand" href="Admin.aspx" style="padding: 1px 8px;">
                <img
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a id="myLessons" onserverclick="myLessons_ServerClick" runat="server"><i class="fa fa-book"></i>Derslerim</a>
                    </li>

                    <li id="nav_users">
                        <a id="myAnnouncements"  onserverclick="myAnnouncements_ServerClick" runat="server"><i class="fa fa-bullhorn"></i>Duyurular</a>
                    </li>
                    <li>
                        <a href="#" onclick="profilGoster()"><i class="fa fa-user-secret"></i>Profilim</a>
                    </li>
